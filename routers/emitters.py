...
def create_emitter(
    ...
    regimeEspecialTributacao: Optional[str] = Form(None),
    regimeApuracaoTributosSN: Optional[str] = Form(None),
    inscricaoMunicipal: Optional[str] = Form(None),
    ...
    # opcional: normaliza só espaços (não força numérico)
    im_clean = (inscricaoMunicipal or "").strip() or None
    ...
    data = {
        ...
        "regimeApuracaoTributosSN": regimeApuracaoTributosSN,
        "inscricaoMunicipal": im_clean,
        "cep": cep,
