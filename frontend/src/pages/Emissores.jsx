  ...
  const handleAbrirModal = (emissorParaEditar = null) => {
    ...
    if (emissorParaEditar) {
      setFormData({
        ...
        regimeEspecialTributacao: emissorParaEditar.regimeEspecialTributacao || "",
        regimeApuracaoTributosSN: emissorParaEditar.regimeApuracaoTributosSN || "",
        inscricaoMunicipal: emissorParaEditar.inscricaoMunicipal || "",
    ...
    try {
      ...
      if (emissorSelecionado && emissorSelecionado._id) {
        const payload = {
          ...
          regimeEspecialTributacao: formData.regimeEspecialTributacao,
          regimeApuracaoTributosSN: formData.regimeApuracaoTributosSN,
        ...
        if (formData.regimeEspecialTributacao) {
            formPayload.append("regimeEspecialTributacao", formData.regimeEspecialTributacao);
        } else {
            formPayload.append("regimeEspecialTributacao", "0"); // Envia 0 se vazio
        }
        formPayload.append("regimeApuracaoTributosSN", formData.regimeApuracaoTributosSN || "1");
        if (formData.inscricaoMunicipal && formData.inscricaoMunicipal.trim()) {
          formPayload.append("inscricaoMunicipal", formData.inscricaoMunicipal.trim());
        }
              ...
              <div className="form-grid">
                ...
                <label>
                  ...
                  >
                    ...
                    <option value="1">Ato Cooperado (Cooperativa)</option>
                ...
                {/* 4. EXIBIR APENAS SE FOR SIMPLES NACIONAL (Opcional, mas melhora a UX) */}
                {formData.regimeTributacao === "Simples Nacional" && (
                  <label style={{ gridColumn: "1 / -1" }}> {/* Ocupa linha inteira se precisar */}
                    Regime de Apuração do Simples Nacional:
                    <select
                      name="regimeApuracaoTributosSN"
                      value={formData.regimeApuracaoTributosSN}
                      onChange={handleInputChange}
                      style={{ width: "100%", textOverflow: "ellipsis" }}
                    >
                      <option value="">Selecione...</option>
                      <option value="1">
                        1 - Apuração dos tributos federais e municipal pelo Simples Nacional (DAS)
                      </option>
                      <option value="2">
                        2 - Tributos federais pelo SN e ISSQN pela NFS-e (Guia Municipal/Fixa)
                      </option>
                      <option value="3">
                        3 - Tributos federais e municipal pela NFS-e (Excesso Sublimite)
                      </option>
                    </select>
                  </label>
                )}
